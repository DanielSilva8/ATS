...
public class Registo{
    public void executa(Utilizadores utilizadores, HashMap<String,Veiculo> veiculos) {
        ...
        if (i!=1 && i!=2 && i!=3)
            ...
            if(i==1)
                registarUtilizador(utilizadores, "motorista");
            else if(i==2)
                registarUtilizador(utilizadores, "cliente");
            else
    ...
    public void registarUtilizador(Utilizadores utilizadores, String tipo) {
        Scanner scin = new Scanner(System.in);
    ...
    public void registarVeiculo(HashMap<String,Veiculo> veiculos){
        int vm;
        String matricula;
        double pb;
        int i=0;
